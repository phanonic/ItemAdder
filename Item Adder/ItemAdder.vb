...
Public Class ItemAdder
    ...
    Public Sub fillitemedit()
        ...
        If cmbItemSubclass.Items.Count > 0 Then cmbItemSubclass.SelectedIndex = subclass
    ...
    Private Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Reader.HasRows And itemid <> "" Then
            ...
            txtSIS.Text = itemid & " already in database."
        Else
            If checkitem() = False Then
                txtSIS.ForeColor = Color.Red
                txtSIS.Text = itemid & " not found on web."
            End If

            If checkitem() = True Then
                txtSIS.ForeColor = Color.Green
                txtSIS.Text = itemid & " not in database."
            End If
        End If
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Else
            ...
            name1 = name1.Replace("\", "")
            txtSIS.ForeColor = Color.Green
            txtSIS.Text = name1 & " added successfuly."
            Reader2.Close()
        End If
    End Sub
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If dbcheck() = True Then
            itemdelete()
            txtSIS.Text = itemid & " deleted successfuly."
        Else
